...
插件已进入公开发布阶段，基础功能全部完成。最新版本 `0.1.18.0`，标题栏动态显示版本号。
...
- Version 13 结构：增加 ArenaKeepAttentionEnabled 和 ArenaKeepProvokeEnabled；持续吸引与持续挑衅默认关闭
