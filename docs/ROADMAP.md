...
- Version 12 结构：保留 Version 11 的 BasicComboEnabled、AutoWhistleEnabled，并增加 AutoFinalStrikeEnabled、AutoFinalStrikeHpThreshold；基础连击默认开启，自动兽笛和自动最后一击默认关闭，宝宝血量阈值默认 20%
