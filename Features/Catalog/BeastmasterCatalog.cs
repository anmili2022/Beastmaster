...
public static class BeastmasterCatalog
{
    ...
    [
        new(1, "库西种", BeastmasterCatalogLocationType.Starting, "初始自带"),
        new(2, "松鼠", BeastmasterCatalogLocationType.Field, "黑衣森林中央林区", 154, 23.1f, 17f),
        new(3, "羊羔", BeastmasterCatalogLocationType.Field, "中拉诺西亚", 138, 23.8f, 25.6f),
        ...
        new(7, "石广爬虫", BeastmasterCatalogLocationType.Field, "西萨纳兰", 147, 20.3f, 28.6f),
        ...
        new(10, "胡蜂", BeastmasterCatalogLocationType.Field, "中萨纳兰", 152, 22f, 30f),
        new(11, "九鹫", BeastmasterCatalogLocationType.Field, "西萨纳兰", 147, 21f, 26f),
        new(12, "莫德拉", BeastmasterCatalogLocationType.Field, "中拉诺西亚", 138, 21.4f, 16.3f),
        ...
        new(21, "席茲", BeastmasterCatalogLocationType.Field, "西拉诺西亚", 149, 24.1f, 23.6f),
        new(22, "仙人刺", BeastmasterCatalogLocationType.Field, "西萨纳兰", 147, 27f, 25f),
        new(23, "巨像兵", BeastmasterCatalogLocationType.Field, "南萨纳兰", 153, 24f, 12.3f),
        ...
        new(26, "水牛", BeastmasterCatalogLocationType.Field, "中拉诺西亚", 138, 18.5f, 17.5f),
        new(27, "乌菊石", BeastmasterCatalogLocationType.Field, "西萨纳兰", 147, 16.8f, 14.5f),
        new(28, "巨型蠕虫", BeastmasterCatalogLocationType.Field, "南萨纳兰", 153, 15.2f, 37.5f),
        ...
        new(31, "巨蟾蜍", BeastmasterCatalogLocationType.Field, "西萨纳兰", 147, 23f, 23f),
        ...
        new(35, "火蛟", BeastmasterCatalogLocationType.Field, "南萨纳兰", 153, 25f, 39f),
        ...
        new(40, "鬼魂（暂译）", BeastmasterCatalogLocationType.Unknown, "中拉诺西亚（具体位置未知）", 138),
        ...
        new(47, "冰雪巨像兵", BeastmasterCatalogLocationType.Duty, "凛冽洞天披雪大冰壁"),
